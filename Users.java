...
class Users extends JPanel 
{
	...
	Image bg;
	JScrollPane sp;
	String s[]={"Username","Password","Firstname","Lastname","Mobile","Gender","Email","College","Address"};
	...
	Users(FDemo f)
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				data[y][5]=rs.getString(6);
				data[y][6]=rs.getString(7);
				data[y][7]=rs.getString(8);
				data[y][8]=rs.getString(9);
				y++;
			}
			con.close();
		}
